          ...
          (match uu____11008 with
           | (uvs,f1) ->
               let env1 =
                 ...
                 {
                   FStar_SMTEncoding_Env.bvar_bindings =
                     (uu___394_11020.FStar_SMTEncoding_Env.bvar_bindings);
                   FStar_SMTEncoding_Env.fvar_bindings =
                     (uu___394_11020.FStar_SMTEncoding_Env.fvar_bindings);
                   FStar_SMTEncoding_Env.depth =
                     (uu___394_11020.FStar_SMTEncoding_Env.depth);
                   FStar_SMTEncoding_Env.tcenv = uu____11021;
                   FStar_SMTEncoding_Env.warn =
                     (uu___394_11020.FStar_SMTEncoding_Env.warn);
                   FStar_SMTEncoding_Env.cache =
                     (uu___394_11020.FStar_SMTEncoding_Env.cache);
                   FStar_SMTEncoding_Env.nolabels =
                     (uu___394_11020.FStar_SMTEncoding_Env.nolabels);
                   FStar_SMTEncoding_Env.use_zfuel_name =
                     (uu___394_11020.FStar_SMTEncoding_Env.use_zfuel_name);
                   FStar_SMTEncoding_Env.encode_non_total_function_typ =
                     (uu___394_11020.FStar_SMTEncoding_Env.encode_non_total_function_typ);
                   FStar_SMTEncoding_Env.current_module_name =
                     (uu___394_11020.FStar_SMTEncoding_Env.current_module_name);
                   FStar_SMTEncoding_Env.encoding_quantifier =
                     (uu___394_11020.FStar_SMTEncoding_Env.encoding_quantifier)
                 }  in
               let f2 =
                 FStar_TypeChecker_Normalize.normalize
                   [FStar_TypeChecker_Env.Beta;
                     ...
                     let val_decl =
                       let uu___395_11132 = se  in
                       {
                         ...
                         FStar_Syntax_Syntax.sigrng =
                           (uu___395_11132.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (FStar_Syntax_Syntax.Irreducible ::
                           (se.FStar_Syntax_Syntax.sigquals));
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___395_11132.FStar_Syntax_Syntax.sigmeta);
                         FStar_Syntax_Syntax.sigattrs =
                           (uu___395_11132.FStar_Syntax_Syntax.sigattrs)
                       }  in
           ...
           | FStar_Pervasives_Native.None  ->
               let se1 =
                 ...
                 let uu____11382 = FStar_Ident.range_of_lid l  in
                 {
                   ...
                   FStar_Syntax_Syntax.sigquals =
                     (uu___396_11381.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___396_11381.FStar_Syntax_Syntax.sigmeta);
                   FStar_Syntax_Syntax.sigattrs =
                     (uu___396_11381.FStar_Syntax_Syntax.sigattrs)
                 }  in
...
let (get_env :
  ...
  fun cmn  ->
    fun tcenv  ->
      ...
      | e::uu____15124 ->
          let uu___397_15127 = e  in
          let uu____15128 = FStar_Ident.string_of_lid cmn  in
          {
            FStar_SMTEncoding_Env.bvar_bindings =
              (uu___397_15127.FStar_SMTEncoding_Env.bvar_bindings);
            FStar_SMTEncoding_Env.fvar_bindings =
              (uu___397_15127.FStar_SMTEncoding_Env.fvar_bindings);
            FStar_SMTEncoding_Env.depth =
              (uu___397_15127.FStar_SMTEncoding_Env.depth);
            FStar_SMTEncoding_Env.tcenv = tcenv;
            FStar_SMTEncoding_Env.warn =
              (uu___397_15127.FStar_SMTEncoding_Env.warn);
            FStar_SMTEncoding_Env.cache =
              (uu___397_15127.FStar_SMTEncoding_Env.cache);
            FStar_SMTEncoding_Env.nolabels =
              (uu___397_15127.FStar_SMTEncoding_Env.nolabels);
            FStar_SMTEncoding_Env.use_zfuel_name =
              (uu___397_15127.FStar_SMTEncoding_Env.use_zfuel_name);
            FStar_SMTEncoding_Env.encode_non_total_function_typ =
              (uu___397_15127.FStar_SMTEncoding_Env.encode_non_total_function_typ);
            FStar_SMTEncoding_Env.current_module_name = uu____15128;
            FStar_SMTEncoding_Env.encoding_quantifier =
              (uu___397_15127.FStar_SMTEncoding_Env.encoding_quantifier)
          }
    ...
    fun fact_db_ids  ->
      fun d  ->
        ...
        | (uu____15619::uu____15620,FStar_SMTEncoding_Term.Assume a) ->
            FStar_SMTEncoding_Term.Assume
              (let uu___398_15628 = a  in
               {
                 FStar_SMTEncoding_Term.assumption_term =
                   (uu___398_15628.FStar_SMTEncoding_Term.assumption_term);
                 FStar_SMTEncoding_Term.assumption_caption =
                   (uu___398_15628.FStar_SMTEncoding_Term.assumption_caption);
                 FStar_SMTEncoding_Term.assumption_name =
                   (uu___398_15628.FStar_SMTEncoding_Term.assumption_name);
      ...
      then ()
        ...
        (let name =
         ...
         (let env = get_env modul.FStar_Syntax_Syntax.name tcenv  in
          ...
          let uu____15900 =
            encode_signature
              (let uu___399_15909 = env  in
               {
                 FStar_SMTEncoding_Env.bvar_bindings =
                   (uu___399_15909.FStar_SMTEncoding_Env.bvar_bindings);
                 FStar_SMTEncoding_Env.fvar_bindings =
                   (uu___399_15909.FStar_SMTEncoding_Env.fvar_bindings);
                 FStar_SMTEncoding_Env.depth =
                   (uu___399_15909.FStar_SMTEncoding_Env.depth);
                 FStar_SMTEncoding_Env.tcenv =
                   (uu___399_15909.FStar_SMTEncoding_Env.tcenv);
                 FStar_SMTEncoding_Env.warn = false;
                 FStar_SMTEncoding_Env.cache =
                   (uu___399_15909.FStar_SMTEncoding_Env.cache);
                 FStar_SMTEncoding_Env.nolabels =
                   (uu___399_15909.FStar_SMTEncoding_Env.nolabels);
                 FStar_SMTEncoding_Env.use_zfuel_name =
                   (uu___399_15909.FStar_SMTEncoding_Env.use_zfuel_name);
                 FStar_SMTEncoding_Env.encode_non_total_function_typ =
                   (uu___399_15909.FStar_SMTEncoding_Env.encode_non_total_function_typ);
                 FStar_SMTEncoding_Env.current_module_name =
                   (uu___399_15909.FStar_SMTEncoding_Env.current_module_name);
                 FStar_SMTEncoding_Env.encoding_quantifier =
                   (uu___399_15909.FStar_SMTEncoding_Env.encoding_quantifier)
          ...
          | (decls,env1) ->
              ...
              (set_env
                 (let uu___400_15949 = env1  in
                  {
                    FStar_SMTEncoding_Env.bvar_bindings =
                      (uu___400_15949.FStar_SMTEncoding_Env.bvar_bindings);
                    FStar_SMTEncoding_Env.fvar_bindings =
                      (uu___400_15949.FStar_SMTEncoding_Env.fvar_bindings);
                    FStar_SMTEncoding_Env.depth =
                      (uu___400_15949.FStar_SMTEncoding_Env.depth);
                    FStar_SMTEncoding_Env.tcenv =
                      (uu___400_15949.FStar_SMTEncoding_Env.tcenv);
                    FStar_SMTEncoding_Env.warn = true;
                    FStar_SMTEncoding_Env.cache =
                      (uu___400_15949.FStar_SMTEncoding_Env.cache);
                    FStar_SMTEncoding_Env.nolabels =
                      (uu___400_15949.FStar_SMTEncoding_Env.nolabels);
                    FStar_SMTEncoding_Env.use_zfuel_name =
                      (uu___400_15949.FStar_SMTEncoding_Env.use_zfuel_name);
                    FStar_SMTEncoding_Env.encode_non_total_function_typ =
                      (uu___400_15949.FStar_SMTEncoding_Env.encode_non_total_function_typ);
                    FStar_SMTEncoding_Env.current_module_name =
                      (uu___400_15949.FStar_SMTEncoding_Env.current_module_name);
                    FStar_SMTEncoding_Env.encoding_quantifier =
                      (uu___400_15949.FStar_SMTEncoding_Env.encoding_quantifier)
                  });
               (let uu____15952 =
                  FStar_TypeChecker_Env.debug tcenv FStar_Options.Medium  in
                if uu____15952
    ...
    fun tcenv  ->
      fun q  ->
        (let uu____16017 =
           ...
           uu____16019.FStar_Ident.str  in
         FStar_SMTEncoding_Z3.query_logging.FStar_SMTEncoding_Z3.set_module_name
           uu____16017);
        (let env =
           let uu____16021 = FStar_TypeChecker_Env.current_module tcenv  in
           get_env uu____16021 tcenv  in
         let uu____16022 =
           let rec aux bindings =
             match bindings with
             | (FStar_Syntax_Syntax.Binding_var x)::rest ->
                 let uu____16061 = aux rest  in
                 (match uu____16061 with
                  | (out,rest1) ->
                      let t =
                        ...
                        | FStar_Pervasives_Native.Some uu____16092 ->
                            let uu____16093 =
                              FStar_Syntax_Syntax.new_bv
                                FStar_Pervasives_Native.None
                                FStar_Syntax_Syntax.t_unit
                               in
                            FStar_Syntax_Util.refine uu____16093
                              x.FStar_Syntax_Syntax.sort
                        | uu____16094 -> x.FStar_Syntax_Syntax.sort  in
                      let t1 =
                        FStar_TypeChecker_Normalize.normalize
                          [FStar_TypeChecker_Env.Eager_unfolding;
                          FStar_TypeChecker_Env.Beta;
                      ...
                      let uu____16098 =
                        let uu____16101 =
                          FStar_Syntax_Syntax.mk_binder
                            (let uu___401_16104 = x  in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___401_16104.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___401_16104.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = t1
                             })
                           in
                        uu____16101 :: out  in
                      (uu____16098, rest1))
             | uu____16109 -> ([], bindings)  in
           let uu____16116 = aux tcenv.FStar_TypeChecker_Env.gamma  in
           ...
           | (closing,bindings) ->
               let uu____16143 =
                 FStar_Syntax_Util.close_forall_no_univs
                  ...
                  in
               (uu____16143, bindings)
            in
         match uu____16022 with
         | (q1,bindings) ->
             let uu____16174 = encode_env_bindings env bindings  in
             (match uu____16174 with
              | (env_decls,env1) ->
                  ((let uu____16196 =
                    ...
                    if uu____16196
                    then
                      let uu____16203 = FStar_Syntax_Print.term_to_string q1
                         in
                    ...
                    | (phi,qdecls) ->
                        let uu____16229 =
                          ...
                          FStar_SMTEncoding_ErrorReporting.label_goals
                            use_env_msg uu____16234 phi
                           in
                        (match uu____16229 with
                         | (labels,phi1) ->
                             let uu____16251 = encode_labels labels  in
