    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_meta (e,m) ->
          ...
          (match m with
           ...
           | FStar_Syntax_Syntax.Meta_labeled (l,uu____5077,p) ->
               let uu____5079 =
                 let uu____5080 =
                   let uu____5087 = resugar_term' env e  in
                   (uu____5087, l, p)  in
                 FStar_Parser_AST.Labeled uu____5080  in
               mk1 uu____5079
           ...
           | FStar_Syntax_Syntax.Meta_monadic (name1,t1) ->
               let uu____5096 =
                 let uu____5097 =
                   let uu____5106 = resugar_term' env e  in
                   let uu____5107 =
                     let uu____5108 =
                       let uu____5109 =
                         let uu____5120 =
                           let uu____5127 =
                             let uu____5132 = resugar_term' env t1  in
                             (uu____5132, FStar_Parser_AST.Nothing)  in
                           [uu____5127]  in
                         (name1, uu____5120)  in
                       FStar_Parser_AST.Construct uu____5109  in
                     mk1 uu____5108  in
                   (uu____5106, uu____5107, FStar_Pervasives_Native.None)  in
                 FStar_Parser_AST.Ascribed uu____5097  in
               mk1 uu____5096
           | FStar_Syntax_Syntax.Meta_monadic_lift (name1,uu____5150,t1) ->
               let uu____5156 =
                 let uu____5157 =
                   ...
                   let uu____5167 =
                     let uu____5168 =
                       let uu____5169 =
                         let uu____5180 =
                           let uu____5187 =
                             let uu____5192 = resugar_term' env t1  in
                             (uu____5192, FStar_Parser_AST.Nothing)  in
                           [uu____5187]  in
                         (name1, uu____5180)  in
                       FStar_Parser_AST.Construct uu____5169  in
                     mk1 uu____5168  in
                   (uu____5166, uu____5167, FStar_Pervasives_Native.None)  in
    ...
    fun c  ->
               ...
               mk1
                 (FStar_Parser_AST.Construct
                    (FStar_Parser_Const.effect_GTot_lid,
                      [(t, FStar_Parser_AST.Nothing)]))
           | FStar_Pervasives_Native.Some u1 ->
               let uu____5304 = FStar_Options.print_universes ()  in
               if uu____5304
               then
                 let u2 = resugar_universe u1 c.FStar_Syntax_Syntax.pos  in
                 mk1
      ...
      | FStar_Syntax_Syntax.Comp c1 ->
          let result =
            ...
            (uu____5345, FStar_Parser_AST.Nothing)  in
          let uu____5346 = FStar_Options.print_effect_args ()  in
          if uu____5346
          then
            let universe =
                    ...
                    let post1 =
                      let uu____5450 =
                        FStar_Syntax_Util.unthunk_lemma_post
                         ...
                         in
                      (uu____5450, (FStar_Pervasives_Native.snd post))  in
                    let uu____5461 =
                      let uu____5470 =
                        FStar_Syntax_Util.is_fvar FStar_Parser_Const.true_lid
                          (FStar_Pervasives_Native.fst pre)
                         in
                      if uu____5470 then [] else [pre]  in
                    let uu____5502 =
                      let uu____5511 =
                        let uu____5520 =
                          FStar_Syntax_Util.is_fvar
                           ...
                           in
                        if uu____5520 then [] else [pats]  in
                      FStar_List.append [post1] uu____5511  in
                    FStar_List.append uu____5461 uu____5502
                | uu____5576 -> c1.FStar_Syntax_Syntax.effect_args
            ...
            let args1 =
              FStar_List.map
                (fun uu____5609  ->
                   ...
                   | (e,uu____5621) ->
                       let uu____5626 = resugar_term' env e  in
                       (uu____5626, FStar_Parser_AST.Nothing)) args
               in
            let rec aux l uu___199_5651 =
              match uu___199_5651 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
                   | FStar_Syntax_Syntax.DECREASES e ->
                       let e1 =
                         let uu____5684 = resugar_term' env e  in
                         (uu____5684, FStar_Parser_AST.Nothing)  in
                       aux (e1 :: l) tl1
                   | uu____5689 -> aux l tl1)
               in
  ...
  fun env  ->
    fun b  ->
      fun r  ->
        ...
        | (x,aq) ->
            let uu____5744 = resugar_arg_qual env aq  in
            FStar_Util.map_opt uu____5744
              (fun imp  ->
                 let e = resugar_term' env x.FStar_Syntax_Syntax.sort  in
                 match e.FStar_Parser_AST.tm with
                 | FStar_Parser_AST.Wild  ->
                     let uu____5758 =
                       let uu____5759 = bv_as_unique_ident x  in
                       FStar_Parser_AST.Variable uu____5759  in
                     FStar_Parser_AST.mk_binder uu____5758 r
                       FStar_Parser_AST.Type_level imp
                 | uu____5760 ->
                     let uu____5761 = FStar_Syntax_Syntax.is_null_bv x  in
                     if uu____5761
                     then
                       ...
                       (let uu____5763 =
                          let uu____5764 =
                            let uu____5769 = bv_as_unique_ident x  in
                            (uu____5769, e)  in
                          FStar_Parser_AST.Annotated uu____5764  in
                        FStar_Parser_AST.mk_binder uu____5763 r
                          FStar_Parser_AST.Type_level imp))
    ...
    fun v1  ->
      fun aqual  ->
        fun body_bv  ->
          fun typ_opt  ->
            let mk1 a =
              let uu____5789 = FStar_Syntax_Syntax.range_of_bv v1  in
              FStar_Parser_AST.mk_pattern a uu____5789  in
            ...
            let pat =
              let uu____5792 =
                ...
                then
                  let uu____5793 =
                    let uu____5800 = bv_as_unique_ident v1  in
                    (uu____5800, aqual)  in
                  FStar_Parser_AST.PatVar uu____5793
            ...
            | FStar_Pervasives_Native.Some
                { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_unknown ;
                  FStar_Syntax_Syntax.pos = uu____5806;
                  FStar_Syntax_Syntax.vars = uu____5807;_}
                -> pat
            | FStar_Pervasives_Native.Some typ ->
                let uu____5817 = FStar_Options.print_bound_var_types ()  in
                if uu____5817
                then
                  let uu____5818 =
                    let uu____5819 =
                      let uu____5830 =
                        let uu____5837 = resugar_term' env typ  in
                        (uu____5837, FStar_Pervasives_Native.None)  in
                      (pat, uu____5830)  in
                    FStar_Parser_AST.PatAscribed uu____5819  in
                  mk1 uu____5818
                else pat
...
and (resugar_bv_as_pat :
  ...
  fun env  ->
    fun x  ->
      fun qual  ->
        fun body_bv  ->
          let uu____5857 = resugar_arg_qual env qual  in
            ...
            (fun aqual  ->
               let uu____5869 =
                 ...
                 FStar_All.pipe_left
                   ...
                   uu____5874
                  in
               resugar_bv_as_pat' env x aqual body_bv uu____5869)
    ...
    fun p  ->
      fun branch_bv  ->
        ...
        let may_drop_implicits args =
          (let uu____5937 = FStar_Options.print_implicits ()  in
                 ...
                 (fun uu____5950  ->
                    ...
                    | (pattern,is_implicit1) ->
                        let might_be_used =
                          ...
                          | FStar_Syntax_Syntax.Pat_dot_term (bv,uu____5966)
                              -> FStar_Util.set_mem bv branch_bv
                          | FStar_Syntax_Syntax.Pat_wild uu____5971 -> false
                          | uu____5972 -> true  in
        ...
        let rec resugar_plain_pat_cons fv args =
          let args1 =
            let uu____6035 = may_drop_implicits args  in
            if uu____6035 then filter_pattern_imp args else args  in
          let args2 =
            FStar_List.map
              (fun uu____6055  ->
        ...
        and aux p1 imp_opt =
          ...
          | FStar_Syntax_Syntax.Pat_cons (fv,args) when
              ...
              ((let uu____6101 =
                  let uu____6102 =
                    let uu____6103 = filter_pattern_imp args  in
                    FStar_List.isEmpty uu____6103  in
          ...
          | FStar_Syntax_Syntax.Pat_cons (fv,args) when
              (FStar_Ident.lid_equals
                ...
                && (may_drop_implicits args)
              ->
              let uu____6139 = filter_pattern_imp args  in
          ...
          | FStar_Syntax_Syntax.Pat_cons
              ({ FStar_Syntax_Syntax.fv_name = uu____6260;
                 FStar_Syntax_Syntax.fv_delta = uu____6261;
              ...
              let fields1 =
                let uu____6288 =
                  FStar_All.pipe_right fields
                   ...
                   in
                FStar_All.pipe_right uu____6288 FStar_List.rev  in
              let args1 =
                let uu____6304 =
                  FStar_All.pipe_right args
                    (FStar_List.map
                   ...
                   in
                FStar_All.pipe_right uu____6304 FStar_List.rev  in
              let rec map21 l1 l2 =
                match (l1, l2) with
                | ([],[]) -> []
                | ([],hd1::tl1) -> []
                | (hd1::tl1,[]) ->
                    let uu____6396 = map21 tl1 []  in
                    (hd1,
                      (mk1
                      ...
                      :: uu____6396
                | (hd1::tl1,hd2::tl2) ->
                    let uu____6419 = map21 tl1 tl2  in (hd1, hd2) ::
                      uu____6419
                 in
              let args2 =
                let uu____6437 = map21 fields1 args1  in
          ...
          | FStar_Syntax_Syntax.Pat_var v1 ->
              ...
              (match uu____6479 with
               | FStar_Pervasives_Native.Some (op,uu____6489) ->
                   let uu____6500 =
                     let uu____6501 =
                       FStar_Ident.mk_ident
                         (op,
                        ...
                        in
                     FStar_Parser_AST.PatOp uu____6501  in
                   mk1 uu____6500
               | FStar_Pervasives_Native.None  ->
                   let uu____6508 = to_arg_qual imp_opt  in
                   resugar_bv_as_pat' env v1 uu____6508 branch_bv
                     FStar_Pervasives_Native.None)
          | FStar_Syntax_Syntax.Pat_wild uu____6513 ->
              let uu____6514 =
                let uu____6515 = to_arg_qual imp_opt  in
                FStar_Parser_AST.PatWild uu____6515  in
              mk1 uu____6514
  ...
  fun env  ->
    fun q  ->
      ...
      | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Meta t) ->
          let uu____6551 =
            let uu____6554 =
              let uu____6555 = resugar_term' env t  in
              FStar_Parser_AST.Meta uu____6555  in
            FStar_Pervasives_Native.Some uu____6554  in
  ...
  fun env  ->
    fun q  ->
      ...
      | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (true ))
          -> FStar_Parser_AST.Nothing
      | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Meta t) ->
          let uu____6565 = resugar_term' env t  in
          FStar_Parser_AST.HashBrace uu____6565
...
let (resugar_qualifier :
  ...
  fun uu___200_6572  ->
    ...
    | FStar_Syntax_Syntax.Reflectable uu____6579 ->
        FStar_Pervasives_Native.Some FStar_Parser_AST.Reflectable
    | FStar_Syntax_Syntax.Discriminator uu____6580 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Projector uu____6581 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordType uu____6586 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordConstructor uu____6595 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Action uu____6604 -> FStar_Pervasives_Native.None
    ...
    fun datacon_ses  ->
      fun se  ->
        ...
        | FStar_Syntax_Syntax.Sig_inductive_typ
            (tylid,uvs,bs,t,uu____6648,datacons) ->
            let uu____6658 =
                ...
                (FStar_List.partition
                   (fun se1  ->
                      ...
                      | FStar_Syntax_Syntax.Sig_datacon
                          (uu____6685,uu____6686,uu____6687,inductive_lid,uu____6689,uu____6690)
                          -> FStar_Ident.lid_equals inductive_lid tylid
                      | uu____6695 -> failwith "unexpected"))
               in
            (match uu____6658 with
             | (current_datacons,other_datacons) ->
                 let bs1 =
                   let uu____6714 = FStar_Options.print_implicits ()  in
                   if uu____6714 then bs else filter_imp bs  in
                 let bs2 =
                 ...
                 let tyc =
                   let uu____6728 =
                     FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                       (FStar_Util.for_some
                          (fun uu___202_6733  ->
                             match uu___202_6733 with
                             | FStar_Syntax_Syntax.RecordType uu____6734 ->
                                 true
                             | uu____6743 -> false))
                      in
                   if uu____6728
                   then
                     let resugar_datacon_as_fields fields se1 =
                       match se1.FStar_Syntax_Syntax.sigel with
                       | FStar_Syntax_Syntax.Sig_datacon
                           (uu____6795,univs1,term,uu____6798,num,uu____6800)
                           ->
                           let uu____6805 =
                             let uu____6806 =
                           ...
                           (match uu____6805 with
                            | FStar_Syntax_Syntax.Tm_arrow (bs3,uu____6820)
                                ->
                                let mfields =
                                          ...
                                          | (b,qual) ->
                                              ...
                                              let uu____6911 =
                                                resugar_term' env
                                                 ...
                                                 in
                                              (uu____6910, uu____6911,
                                                FStar_Pervasives_Native.None)))
                                   in
                                FStar_List.append mfields fields
                            | uu____6922 -> failwith "unexpected")
                       | uu____6933 -> failwith "unexpected"  in
                     let fields =
                     ...
                     (let resugar_datacon constructors se1 =
                        match se1.FStar_Syntax_Syntax.sigel with
                        | FStar_Syntax_Syntax.Sig_datacon
                            (l,univs1,term,uu____7058,num,uu____7060) ->
                            let c =
                              let uu____7078 =
                                let uu____7081 = resugar_term' env term  in
                                FStar_Pervasives_Native.Some uu____7081  in
                              ((l.FStar_Ident.ident), uu____7078,
                                FStar_Pervasives_Native.None, false)
                               in
                            c :: constructors
                        | uu____7098 -> failwith "unexpected"  in
                      let constructors =
...
let (mk_decl :
  ...
  fun r  ->
    fun q  ->
      fun d'  ->
        let uu____7196 = FStar_List.choose resugar_qualifier q  in
        {
          FStar_Parser_AST.d = d';
          FStar_Parser_AST.drange = r;
          FStar_Parser_AST.doc = FStar_Pervasives_Native.None;
          FStar_Parser_AST.quals = uu____7196;
              ...
              let uu____7235 =
                let uu____7250 =
                  let uu____7259 =
                    let uu____7266 =
                      let uu____7267 =
                        let uu____7280 = resugar_term' env typ  in
                        (name1, [], FStar_Pervasives_Native.None, uu____7280)
                         in
                      FStar_Parser_AST.TyconAbbrev uu____7267  in
                    (uu____7266, FStar_Pervasives_Native.None)  in
                  [uu____7259]  in
                (false, false, uu____7250)  in
              FStar_Parser_AST.Tycon uu____7235  in
            mk_decl typ.FStar_Syntax_Syntax.pos [] uu____7234
      ...
      fun r  ->
        fun q  ->
          fun ed  ->
            let resugar_action d for_free1 =
              ...
              | (bs,action_defn) ->
                  ...
                  (match uu____7365 with
                   | (bs1,action_typ) ->
                       let action_params1 =
                         let uu____7375 = FStar_Options.print_implicits ()
                            in
                         if uu____7375
                         then action_params
                         ...
                         let a =
                           let uu____7398 =
                             ...
                             (uu____7409,
                              ...
                              in
                           FStar_Parser_AST.Construct uu____7398  in
                         let t =
            ...
            | (eff_binders,eff_typ) ->
                let eff_binders1 =
                  let uu____7493 = FStar_Options.print_implicits ()  in
                  if uu____7493 then eff_binders else filter_imp eff_binders
                   in
                let eff_binders2 =
                  let uu____7500 =
                    FStar_All.pipe_right eff_binders1
                     ...
                     in
                  FStar_All.pipe_right uu____7500 FStar_List.rev  in
    ...
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_bundle (ses,uu____7568) ->
          let uu____7577 =
            FStar_All.pipe_right ses
              (FStar_List.partition
                 (fun se1  ->
                    match se1.FStar_Syntax_Syntax.sigel with
                    | FStar_Syntax_Syntax.Sig_inductive_typ uu____7599 ->
                        true
                    | FStar_Syntax_Syntax.Sig_declare_typ uu____7616 -> true
                    | FStar_Syntax_Syntax.Sig_datacon uu____7623 -> false
                    | uu____7638 ->
                        failwith
          ...
          (match uu____7577 with
           | (decl_typ_ses,datacon_ses) ->
               let retrieve_datacons_and_resugar uu____7674 se1 =
                 match uu____7674 with
                 | (datacon_ses1,tycons) ->
                     let uu____7700 = resugar_typ env datacon_ses1 se1  in
                             ...
                             let uu____7752 =
                               let uu____7767 =
                                 FStar_List.map
                                   ...
                                   tycons
                                  in
                               (false, false, uu____7767)  in
                             FStar_Parser_AST.Tycon uu____7752  in
                           decl'_to_decl se uu____7751  in
                         FStar_Pervasives_Native.Some uu____7750
                     | se1::[] ->
                         (match se1.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_datacon
                              (l,uu____7798,uu____7799,uu____7800,uu____7801,uu____7802)
                              ->
                              let uu____7807 =
                                decl'_to_decl se1
                                  (FStar_Parser_AST.Exception
                                     ((l.FStar_Ident.ident),
                                       FStar_Pervasives_Native.None))
                                 in
                              FStar_Pervasives_Native.Some uu____7807
                          | uu____7810 ->
                              failwith
                                "wrong format for resguar to Exception")
                     | uu____7813 -> failwith "Should not happen hopefully")))
      | FStar_Syntax_Syntax.Sig_let (lbs,uu____7819) ->
          let uu____7824 =
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___203_7830  ->
                    match uu___203_7830 with
                    | FStar_Syntax_Syntax.Projector (uu____7831,uu____7832)
                        -> true
                    | FStar_Syntax_Syntax.Discriminator uu____7833 -> true
                    | uu____7834 -> false))
             in
          if uu____7824
          then FStar_Pervasives_Native.None
            ...
            (let mk1 e =
             ...
             | FStar_Parser_AST.Let (isrec,lets,uu____7865) ->
                 let uu____7894 =
                   let uu____7895 =
                     let uu____7896 =
                       let uu____7907 =
                       ...
                       (isrec, uu____7907)  in
                     FStar_Parser_AST.TopLevelLet uu____7896  in
                   decl'_to_decl se uu____7895  in
                 FStar_Pervasives_Native.Some uu____7894
             | uu____7944 -> failwith "Should not happen hopefully")
      | FStar_Syntax_Syntax.Sig_assume (lid,uu____7948,fml) ->
          let uu____7950 =
            let uu____7951 =
              let uu____7952 =
                let uu____7957 = resugar_term' env fml  in
                ((lid.FStar_Ident.ident), uu____7957)  in
              FStar_Parser_AST.Assume uu____7952  in
            decl'_to_decl se uu____7951  in
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect e ->
          ...
          let lift_wp =
            ...
            | FStar_Pervasives_Native.Some (uu____7970,t) ->
                let uu____7980 = resugar_term' env t  in
                FStar_Pervasives_Native.Some uu____7980
            | uu____7981 -> FStar_Pervasives_Native.None  in
          let lift =
            match e.FStar_Syntax_Syntax.lift with
            | FStar_Pervasives_Native.Some (uu____7989,t) ->
                let uu____7999 = resugar_term' env t  in
                FStar_Pervasives_Native.Some uu____7999
            | uu____8000 -> FStar_Pervasives_Native.None  in
          let op =
            ...
            | uu____8024 -> failwith "Should not happen hopefully"  in
          let uu____8033 =
            decl'_to_decl se
      ...
      | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,vs,bs,c,flags1) ->
          let uu____8043 = FStar_Syntax_Subst.open_comp bs c  in
          (match uu____8043 with
           | (bs1,c1) ->
               let bs2 =
                 let uu____8055 = FStar_Options.print_implicits ()  in
                 if uu____8055 then bs1 else filter_imp bs1  in
               let bs3 =
                   ...
                   let uu____8070 =
                     let uu____8085 =
                       let uu____8094 =
                         let uu____8101 =
                           let uu____8102 =
                             let uu____8115 = resugar_comp' env c1  in
                             ((lid.FStar_Ident.ident), bs3,
                               FStar_Pervasives_Native.None, uu____8115)
                              in
                           FStar_Parser_AST.TyconAbbrev uu____8102  in
                         (uu____8101, FStar_Pervasives_Native.None)  in
                       [uu____8094]  in
                     (false, false, uu____8085)  in
                   FStar_Parser_AST.Tycon uu____8070  in
                 decl'_to_decl se uu____8069  in
      ...
      | FStar_Syntax_Syntax.Sig_declare_typ (lid,uvs,t) ->
          let uu____8147 =
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___204_8153  ->
                    match uu___204_8153 with
                    | FStar_Syntax_Syntax.Projector (uu____8154,uu____8155)
                        -> true
                    | FStar_Syntax_Syntax.Discriminator uu____8156 -> true
                    | uu____8157 -> false))
             in
          if uu____8147
          then FStar_Pervasives_Native.None
            ...
            (let t' =
               let uu____8162 =
                 (let uu____8165 = FStar_Options.print_universes ()  in
                  Prims.op_Negation uu____8165) || (FStar_List.isEmpty uvs)
                  in
               if uu____8162
               then resugar_term' env t
               else
                 (let uu____8167 = FStar_Syntax_Subst.open_univ_vars uvs t
                     in
                  match uu____8167 with
                  | (uvs1,t1) ->
                      let universes = universe_to_string uvs1  in
                      let uu____8175 = resugar_term' env t1  in
                      label universes uu____8175)
                in
             let uu____8176 =
               decl'_to_decl se
          ...
          let uu____8183 =
            let uu____8184 =
              let uu____8185 =
                ...
                let uu____8197 = resugar_term' env t  in
                (uu____8192, uu____8197)  in
              FStar_Parser_AST.Splice uu____8185  in
            decl'_to_decl se uu____8184  in
          FStar_Pervasives_Native.Some uu____8183
      | FStar_Syntax_Syntax.Sig_inductive_typ uu____8200 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Sig_datacon uu____8217 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Sig_main uu____8232 ->
          FStar_Pervasives_Native.None
...
let (resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term) =
  fun t  -> let uu____8253 = noenv resugar_term'  in uu____8253 t 
let (resugar_sigelt :
  FStar_Syntax_Syntax.sigelt ->
    FStar_Parser_AST.decl FStar_Pervasives_Native.option)
  = fun se  -> let uu____8270 = noenv resugar_sigelt'  in uu____8270 se 
let (resugar_comp : FStar_Syntax_Syntax.comp -> FStar_Parser_AST.term) =
  fun c  -> let uu____8287 = noenv resugar_comp'  in uu____8287 c 
let (resugar_pat :
  FStar_Syntax_Syntax.pat ->
    FStar_Syntax_Syntax.bv FStar_Util.set -> FStar_Parser_AST.pattern)
  =
  fun p  ->
    fun branch_bv  ->
      let uu____8309 = noenv resugar_pat'  in uu____8309 p branch_bv
...
let (resugar_binder :
  ...
  =
  fun b  ->
    fun r  -> let uu____8342 = noenv resugar_binder'  in uu____8342 b r
  
let (resugar_tscheme : FStar_Syntax_Syntax.tscheme -> FStar_Parser_AST.decl)
  = fun ts  -> let uu____8366 = noenv resugar_tscheme'  in uu____8366 ts 
let (resugar_eff_decl :
  Prims.bool ->
    FStar_Range.range ->
      FStar_Syntax_Syntax.qualifier Prims.list ->
  ...
  fun for_free  ->
    fun r  ->
      fun q  ->
        fun ed  ->
          let uu____8398 = noenv resugar_eff_decl'  in
          uu____8398 for_free r q ed
