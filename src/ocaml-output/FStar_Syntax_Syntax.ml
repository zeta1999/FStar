...
type eff_decl =
  ...
  interp: term FStar_Pervasives_Native.option ;
...
let (__proj__Mkeff_decl__item__cattributes : eff_decl -> cflag Prims.list) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ...
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} ->
        cattributes
...
let (__proj__Mkeff_decl__item__mname : eff_decl -> FStar_Ident.lident) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> mname
...
let (__proj__Mkeff_decl__item__univs : eff_decl -> univ_names) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> univs
...
let (__proj__Mkeff_decl__item__binders : eff_decl -> binders) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> binders
...
let (__proj__Mkeff_decl__item__spec : eff_decl -> term_monad) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> spec
...
let (__proj__Mkeff_decl__item__ite_wp : eff_decl -> tscheme) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> ite_wp
...
let (__proj__Mkeff_decl__item__null_wp : eff_decl -> tscheme) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> null_wp
...
let (__proj__Mkeff_decl__item__trivial : eff_decl -> tscheme) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> trivial
...
let (__proj__Mkeff_decl__item__repr : eff_decl -> term_monad) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> repr
...
let (__proj__Mkeff_decl__item__interp :
  eff_decl -> term FStar_Pervasives_Native.option) =
  fun projectee  ->
    match projectee with
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> interp
...
let (__proj__Mkeff_decl__item__actions : eff_decl -> action Prims.list) =
  fun projectee  ->
    ...
    | { cattributes; mname; univs; binders; spec; signature; if_then_else;
        ite_wp; stronger; close_wp; assert_p; assume_p; null_wp; trivial;
        repr; elaborated; spec_dm4f; interp; actions; eff_attrs;_} -> actions
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____7598 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____7674 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____7733 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____7804 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____7848 -> false
...
let (uu___is_Sig_main : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_main _0 -> true | uu____7886 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____7912 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____7950 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____7970 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____8002 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____8058 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l  ->
    FStar_Util.for_some
      (fun uu___87_8307  ->
         match uu___87_8307 with
         | Reflectable uu____8309 -> true
         | uu____8311 -> false) l
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x  ->
    fun r  ->
      let uu___94_8429 = x  in
      let uu____8430 =
        FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____8430;
        index = (uu___94_8429.index);
        sort = (uu___94_8429.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____8467  ->
             ...
             | (bv,t) -> let uu____8478 = f t  in (bv, uu____8478))
          qi.antiquotes
         in
      let uu___95_8479 = qi  in
      { qkind = (uu___95_8479.qkind); antiquotes = aq }
  ...
  fun bv  ->
    fun aq  ->
      let uu____8495 =
        FStar_List.tryFind
          (fun uu____8513  ->
             match uu____8513 with | (bv',uu____8522) -> bv_eq bv bv') aq
         in
      match uu____8495 with
      | FStar_Pervasives_Native.Some (uu____8529,e) ->
          FStar_Pervasives_Native.Some e
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
  
let syn :
  'Auu____8560 'Auu____8561 'Auu____8562 .
    'Auu____8560 ->
      'Auu____8561 ->
        ('Auu____8561 -> 'Auu____8560 -> 'Auu____8562) -> 'Auu____8562
  = fun p  -> fun k  -> fun f  -> f k p 
let mk_fvs :
  'Auu____8604 .
    unit -> 'Auu____8604 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8613  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let mk_uvs :
  'Auu____8632 .
    unit -> 'Auu____8632 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8641  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____8651  -> FStar_Util.new_set order_bv 
let (new_id_set : unit -> FStar_Ident.ident FStar_Util.set) =
  fun uu____8661  -> FStar_Util.new_set order_ident 
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____8671  -> FStar_Util.new_set order_fv 
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8686 = FStar_Ident.text_of_id x  in
      let uu____8688 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8686 uu____8688
  
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____8697  -> FStar_Util.new_set order_univ_name 
let (eq_binding : binding -> binding -> Prims.bool) =
  fun b1  ->
    fun b2  ->
      match (b1, b2) with
      | (Binding_var bv1,Binding_var bv2) -> bv_eq bv1 bv2
      | (Binding_lid (lid1,uu____8716),Binding_lid (lid2,uu____8718)) ->
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t  ->
    fun uu____8813  ->
      fun r  ->
        let uu____8817 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
        { n = t; pos = r; vars = uu____8817 }
  
let (bv_to_tm : bv -> term) =
  fun bv  ->
    let uu____8850 = range_of_bv bv  in
    mk (Tm_bvar bv) FStar_Pervasives_Native.None uu____8850
  
let (bv_to_name : bv -> term) =
  fun bv  ->
    let uu____8857 = range_of_bv bv  in
    mk (Tm_name bv) FStar_Pervasives_Native.None uu____8857
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t  ->
    fun uu___88_8912  ->
      match uu___88_8912 with
      | [] -> t
      | us ->
          (match t.n with
           | Tm_fvar uu____8914 ->
               mk (Tm_uinst (t, us)) FStar_Pervasives_Native.None t.pos
           | uu____8917 -> failwith "Unexpected universe instantiation")
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____8980 -> mk_Tm_app t args' kopt r
  ...
  fun lr  ->
    fun pos  ->
      let uu____9041 =
        let uu____9048 =
          let uu____9049 =
            let uu____9072 = FStar_Util.mk_ref FStar_Pervasives_Native.None
               in
            (lr, uu____9072)  in
          Tm_delayed uu____9049  in
        mk uu____9048  in
      uu____9041 FStar_Pervasives_Native.None pos
...
let (is_type : term -> Prims.bool) =
  fun t  -> match t.n with | Tm_type uu____9300 -> true | uu____9302 -> false 
...
let (null_binder : term -> binder) =
  fun t  ->
    let uu____9338 = null_bv t  in (uu____9338, FStar_Pervasives_Native.None)
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___89_9386  ->
    match uu___89_9386 with
    | { lbname = FStar_Util.Inr uu____9390; lbunivs = uu____9391;
        lbtyp = uu____9392; lbeff = uu____9393; lbdef = uu____9394;
        lbattrs = uu____9395; lbpos = uu____9396;_}::uu____9397 -> true
    | uu____9411 -> false
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____9433  ->
         fun out  ->
           match uu____9433 with | (x,uu____9446) -> FStar_Util.set_add x out)
      bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs  ->
    let uu____9479 = FStar_Util.set_elements fvs  in
    FStar_All.pipe_right uu____9479 binders_of_list
  
let (is_implicit : aqual -> Prims.bool) =
  fun uu___90_9490  ->
    match uu___90_9490 with
    | FStar_Pervasives_Native.Some (Implicit uu____9492) -> true
    | uu____9495 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p  ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____9541 -> b
      | Pat_constant uu____9548 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____9551,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____9585  ->
                 match uu____9585 with | (p2,uu____9598) -> aux b1 p2) b pats
       in
    let uu____9605 = aux [] p  in
    FStar_All.pipe_left FStar_List.rev uu____9605
  
let (gen_reset : ((unit -> Prims.int) * (unit -> unit))) =
  let x = FStar_Util.mk_ref (Prims.parse_int "0")  in
  let gen1 uu____9636 = FStar_Util.incr x; FStar_ST.op_Bang x  in
  let reset uu____9719 = FStar_ST.op_Colon_Equals x (Prims.parse_int "0")  in
  (gen1, reset) 
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        let uu____9843 = next_id ()  in
        { ppname = id1; index = uu____9843; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv  ->
    let uu____9866 = is_null_bv bv  in
    if uu____9866
    then
      let uu____9869 =
        let uu____9872 = range_of_bv bv  in
        FStar_Pervasives_Native.Some uu____9872  in
      new_bv uu____9869 bv.sort
    else
      (let uu___96_9875 = bv  in
       let uu____9876 = next_id ()  in
       {
         ppname = (uu___96_9875.ppname);
         index = uu____9876;
         sort = (uu___96_9875.sort)
       })
...
let (freshen_binder : binder -> binder) =
  fun b  ->
    ...
    | (bv,aq) -> let uu____9891 = freshen_bv bv  in (uu____9891, aq)
...
let (new_univ_name :
  ...
  fun ropt  ->
    ...
    let uu____9906 =
      let uu____9912 =
        let uu____9914 = FStar_Util.string_of_int id1  in
        Prims.strcat FStar_Ident.reserved_prefix uu____9914  in
      (uu____9912, (range_of_ropt ropt))  in
    FStar_Ident.mk_ident uu____9906
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv  ->
    fun r  ->
      let uu___97_10045 = bv  in
      let uu____10046 =
        FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____10046;
        index = (uu___97_10045.index);
        sort = (uu___97_10045.sort)
      }
...
let (lid_as_fv :
  ...
  fun l  ->
    fun dd  ->
      fun dq  ->
        let uu____10068 =
          let uu____10069 = FStar_Ident.range_of_lid l  in
          withinfo l uu____10069  in
        { fv_name = uu____10068; fv_delta = dd; fv_qual = dq }
  
let (fv_to_tm : fv -> term) =
  fun fv  ->
    let uu____10076 = FStar_Ident.range_of_lid (fv.fv_name).v  in
    mk (Tm_fvar fv) FStar_Pervasives_Native.None uu____10076
...
let (fvar :
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____10097 = lid_as_fv l dd dq  in fv_to_tm uu____10097
  
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv  -> (fv.fv_name).v 
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv  ->
    let uu____10110 = lid_of_fv fv  in FStar_Ident.range_of_lid uu____10110
  
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv  ->
    fun r  ->
      let uu___98_10122 = fv  in
      let uu____10123 =
        let uu___99_10124 = fv.fv_name  in
        let uu____10125 =
          let uu____10126 = lid_of_fv fv  in
          FStar_Ident.set_lid_range uu____10126 r  in
        { v = uu____10125; p = (uu___99_10124.p) }  in
      {
        fv_name = uu____10123;
        fv_delta = (uu___98_10122.fv_delta);
        fv_qual = (uu___98_10122.fv_qual)
      }
...
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___93_10152  ->
           match uu___93_10152 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____10157));
               pos = uu____10158; vars = uu____10159;_} when data = s -> true
           | uu____10166 -> false) l
  ...
  fun p1  ->
    fun p2  ->
      ...
      | (Pat_cons (fv1,as1),Pat_cons (fv2,as2)) ->
          let uu____10225 = fv_eq fv1 fv2  in
          if uu____10225
          then
            let uu____10230 = FStar_List.zip as1 as2  in
      ...
      | (Pat_var uu____10335,Pat_var uu____10336) -> true
      | (Pat_wild uu____10338,Pat_wild uu____10339) -> true
      | (Pat_dot_term (bv1,t1),Pat_dot_term (bv2,t2)) -> true
      | (uu____10354,uu____10355) -> false
...
let (tconst : FStar_Ident.lident -> term) =
  fun l  ->
    let uu____10373 =
      let uu____10380 = let uu____10381 = fvconst l  in Tm_fvar uu____10381
         in
      mk uu____10380  in
    uu____10373 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tactic_unit : term) =
  let uu____10428 =
    let uu____10433 =
      let uu____10434 = tabbrev FStar_Parser_Const.tactic_lid  in
      mk_Tm_uinst uu____10434 [U_zero]  in
    let uu____10435 = let uu____10436 = as_arg t_unit  in [uu____10436]  in
    mk_Tm_app uu____10433 uu____10435  in
  uu____10428 FStar_Pervasives_Native.None FStar_Range.dummyRange 
let (t_list_of : term -> term) =
  fun t  ->
    let uu____10469 =
      let uu____10474 =
        let uu____10475 = tabbrev FStar_Parser_Const.list_lid  in
        mk_Tm_uinst uu____10475 [U_zero]  in
      let uu____10476 = let uu____10477 = as_arg t  in [uu____10477]  in
      mk_Tm_app uu____10474 uu____10476  in
    uu____10469 FStar_Pervasives_Native.None FStar_Range.dummyRange
  
let (t_option_of : term -> term) =
  fun t  ->
    let uu____10510 =
      let uu____10515 =
        let uu____10516 = tabbrev FStar_Parser_Const.option_lid  in
        mk_Tm_uinst uu____10516 [U_zero]  in
      let uu____10517 = let uu____10518 = as_arg t  in [uu____10518]  in
      mk_Tm_app uu____10515 uu____10517  in
    uu____10510 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tuple2_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10556 =
        let uu____10561 =
          let uu____10562 = tabbrev FStar_Parser_Const.lid_tuple2  in
          mk_Tm_uinst uu____10562 [U_zero; U_zero]  in
        let uu____10563 =
          let uu____10564 = as_arg t1  in
          let uu____10573 = let uu____10584 = as_arg t2  in [uu____10584]  in
          uu____10564 :: uu____10573  in
        mk_Tm_app uu____10561 uu____10563  in
      uu____10556 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_either_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10630 =
        let uu____10635 =
          let uu____10636 = tabbrev FStar_Parser_Const.either_lid  in
          mk_Tm_uinst uu____10636 [U_zero; U_zero]  in
        let uu____10637 =
          let uu____10638 = as_arg t1  in
          let uu____10647 = let uu____10658 = as_arg t2  in [uu____10658]  in
          uu____10638 :: uu____10647  in
        mk_Tm_app uu____10635 uu____10637  in
      uu____10630 FStar_Pervasives_Native.None FStar_Range.dummyRange
