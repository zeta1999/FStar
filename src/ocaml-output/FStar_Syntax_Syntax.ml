...
let (uu___is_Meta_pattern : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_pattern _0 -> true | uu____3995 -> false
...
let (uu___is_Meta_named : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_named _0 -> true | uu____4050 -> false
...
let (uu___is_Meta_labeled : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_labeled _0 -> true | uu____4077 -> false
...
let (uu___is_Meta_desugared : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_desugared _0 -> true | uu____4120 -> false
...
let (uu___is_Meta_monadic : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic _0 -> true | uu____4145 -> false
...
let (uu___is_Meta_monadic_lift : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic_lift _0 -> true | uu____4190 -> false
...
let (uu___is_Sequence : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sequence  -> true | uu____4232 -> false
  
let (uu___is_Primop : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primop  -> true | uu____4243 -> false
  
let (uu___is_Masked_effect : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Masked_effect  -> true | uu____4254 -> false
  
let (uu___is_Meta_smt_pat : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_smt_pat  -> true | uu____4265 -> false
  
let (uu___is_Data_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Data_ctor  -> true | uu____4276 -> false
  
let (uu___is_Record_projector : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_projector _0 -> true | uu____4292 -> false
...
let (uu___is_Record_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_ctor _0 -> true | uu____4329 -> false
...
let (uu___is_DB : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | DB _0 -> true | uu____4371 -> false
...
let (uu___is_NM : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NM _0 -> true | uu____4410 -> false
...
let (uu___is_NT : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NT _0 -> true | uu____4450 -> false
...
let (uu___is_UN : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UN _0 -> true | uu____4492 -> false
...
let (uu___is_UD : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UD _0 -> true | uu____4531 -> false
...
let (uu___is_BadLazy : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | BadLazy  -> true | uu____4902 -> false
  
let (uu___is_Lazy_bv : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_bv  -> true | uu____4913 -> false
  
let (uu___is_Lazy_binder : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_binder  -> true | uu____4924 -> false
  
let (uu___is_Lazy_fvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_fvar  -> true | uu____4935 -> false
  
let (uu___is_Lazy_comp : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_comp  -> true | uu____4946 -> false
  
let (uu___is_Lazy_env : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_env  -> true | uu____4957 -> false
  
let (uu___is_Lazy_proofstate : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_proofstate  -> true | uu____4968 -> false
  
let (uu___is_Lazy_goal : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_goal  -> true | uu____4979 -> false
  
let (uu___is_Lazy_sigelt : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_sigelt  -> true | uu____4990 -> false
  
let (uu___is_Lazy_uvar : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_uvar  -> true | uu____5001 -> false
  
let (uu___is_Lazy_embedding : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_embedding _0 -> true | uu____5021 -> false
...
let (uu___is_Binding_var : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_var _0 -> true | uu____5064 -> false
  
let (__proj__Binding_var__item___0 : binding -> bv) =
  fun projectee  -> match projectee with | Binding_var _0 -> _0 
let (uu___is_Binding_lid : binding -> Prims.bool) =
  fun projectee  ->
    match projectee with | Binding_lid _0 -> true | uu____5095 -> false
...
let (mk_lcomp :
  ...
  fun eff_name  ->
    fun res_typ  ->
      fun cflags  ->
        fun comp_thunk  ->
          let uu____5578 = FStar_Util.mk_ref (FStar_Util.Inl comp_thunk)  in
          { eff_name; res_typ; cflags; comp_thunk = uu____5578 }
  
let (lcomp_comp : lcomp -> comp) =
  fun lc  ->
    let uu____5604 = FStar_ST.op_Bang lc.comp_thunk  in
...
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Assumption  -> true | uu____5757 -> false
  
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee  -> match projectee with | New  -> true | uu____5768 -> false 
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Private  -> true | uu____5779 -> false
...
let (uu___is_Visible_default : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Visible_default  -> true | uu____5801 -> false
  
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Irreducible  -> true | uu____5812 -> false
  
let (uu___is_Abstract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Abstract  -> true | uu____5823 -> false
...
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____5845 -> false
  
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Noeq  -> true | uu____5856 -> false
  
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Unopteq  -> true | uu____5867 -> false
  
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | TotalEffect  -> true | uu____5878 -> false
  
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Logic  -> true | uu____5889 -> false
  
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reifiable  -> true | uu____5900 -> false
  
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reflectable _0 -> true | uu____5912 -> false
...
let (uu___is_Discriminator : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Discriminator _0 -> true | uu____5931 -> false
...
let (uu___is_Projector : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Projector _0 -> true | uu____5954 -> false
...
let (uu___is_RecordType : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordType _0 -> true | uu____5993 -> false
...
let (uu___is_RecordConstructor : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | RecordConstructor _0 -> true | uu____6044 -> false
...
let (uu___is_Action : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Action _0 -> true | uu____6087 -> false
...
let (uu___is_HasMaskedEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | HasMaskedEffect  -> true | uu____6116 -> false
  
let (uu___is_Effect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Effect  -> true | uu____6127 -> false
  
let (uu___is_OnlyName : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | OnlyName  -> true | uu____6138 -> false
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____7377 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____7452 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____7510 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____7580 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____7623 -> false
...
let (uu___is_Sig_main : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_main _0 -> true | uu____7660 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____7685 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____7722 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____7760 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____7791 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____7846 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_splice _0 -> true | uu____7871 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l  ->
    FStar_Util.for_some
      (fun uu___0_8093  ->
         match uu___0_8093 with
         | Reflectable uu____8095 -> true
         | uu____8097 -> false) l
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x  ->
    fun r  ->
      let uu___422_8215 = x  in
      let uu____8216 =
        FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____8216;
        index = (uu___422_8215.index);
        sort = (uu___422_8215.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____8253  ->
             ...
             | (bv,t) -> let uu____8264 = f t  in (bv, uu____8264))
          qi.antiquotes
         in
      let uu___430_8265 = qi  in
      { qkind = (uu___430_8265.qkind); antiquotes = aq }
  ...
  fun bv  ->
    fun aq  ->
      let uu____8281 =
        FStar_List.tryFind
          (fun uu____8299  ->
             match uu____8299 with | (bv',uu____8308) -> bv_eq bv bv') aq
         in
      match uu____8281 with
      | FStar_Pervasives_Native.Some (uu____8315,e) ->
          FStar_Pervasives_Native.Some e
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
  
let syn :
  'Auu____8346 'Auu____8347 'Auu____8348 .
    'Auu____8346 ->
      'Auu____8347 ->
        ('Auu____8347 -> 'Auu____8346 -> 'Auu____8348) -> 'Auu____8348
...
let mk_uvs :
  'Auu____8396 .
    unit -> 'Auu____8396 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8405  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____8415  -> FStar_Util.new_set order_bv 
let (new_id_set : unit -> FStar_Ident.ident FStar_Util.set) =
  fun uu____8425  -> FStar_Util.new_set order_ident 
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____8435  -> FStar_Util.new_set order_fv 
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8450 = FStar_Ident.text_of_id x  in
      let uu____8452 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8450 uu____8452
  
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____8461  -> FStar_Util.new_set order_univ_name 
let (eq_binding : binding -> binding -> Prims.bool) =
  fun b1  ->
    fun b2  ->
      match (b1, b2) with
      | (Binding_var bv1,Binding_var bv2) -> bv_eq bv1 bv2
      | (Binding_lid (lid1,uu____8480),Binding_lid (lid2,uu____8482)) ->
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t  ->
    fun uu____8571  ->
      fun r  ->
        let uu____8575 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
        { n = t; pos = r; vars = uu____8575 }
  
let (bv_to_tm : bv -> term) =
  fun bv  ->
    let uu____8586 = range_of_bv bv  in
    mk (Tm_bvar bv) FStar_Pervasives_Native.None uu____8586
  
let (bv_to_name : bv -> term) =
  fun bv  ->
    let uu____8593 = range_of_bv bv  in
    mk (Tm_name bv) FStar_Pervasives_Native.None uu____8593
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t  ->
    fun uu___1_8644  ->
      match uu___1_8644 with
      | [] -> t
      | us ->
          (match t.n with
           | Tm_fvar uu____8646 ->
               mk (Tm_uinst (t, us)) FStar_Pervasives_Native.None t.pos
           | uu____8649 -> failwith "Unexpected universe instantiation")
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____8708 -> mk_Tm_app t args' kopt r
  ...
  fun lr  ->
    fun pos  ->
      let uu____8765 =
        let uu____8772 =
          let uu____8773 =
            let uu____8796 = FStar_Util.mk_ref FStar_Pervasives_Native.None
               in
            (lr, uu____8796)  in
          Tm_delayed uu____8773  in
        mk uu____8772  in
      uu____8765 FStar_Pervasives_Native.None pos
...
let (is_type : term -> Prims.bool) =
  fun t  -> match t.n with | Tm_type uu____8999 -> true | uu____9001 -> false 
...
let (null_binder : term -> binder) =
  fun t  ->
    let uu____9027 = null_bv t  in (uu____9027, FStar_Pervasives_Native.None)
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___2_9077  ->
    match uu___2_9077 with
    | { lbname = FStar_Util.Inr uu____9081; lbunivs = uu____9082;
        lbtyp = uu____9083; lbeff = uu____9084; lbdef = uu____9085;
        lbattrs = uu____9086; lbpos = uu____9087;_}::uu____9088 -> true
    | uu____9102 -> false
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____9124  ->
         fun out  ->
           match uu____9124 with | (x,uu____9137) -> FStar_Util.set_add x out)
      bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs  ->
    let uu____9170 = FStar_Util.set_elements fvs  in
    FStar_All.pipe_right uu____9170 binders_of_list
  
let (is_implicit : aqual -> Prims.bool) =
  fun uu___3_9181  ->
    match uu___3_9181 with
    | FStar_Pervasives_Native.Some (Implicit uu____9183) -> true
    | uu____9186 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p  ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____9232 -> b
      | Pat_constant uu____9239 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____9242,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____9276  ->
                 match uu____9276 with | (p2,uu____9289) -> aux b1 p2) b pats
       in
    let uu____9296 = aux [] p  in
    FStar_All.pipe_left FStar_List.rev uu____9296
  
let (range_of_ropt :
  FStar_Range.range FStar_Pervasives_Native.option -> FStar_Range.range) =
  fun uu___5_9310  ->
    match uu___5_9310 with
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        let uu____9350 = FStar_Ident.next_id ()  in
        { ppname = id1; index = uu____9350; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv  ->
    let uu____9373 = is_null_bv bv  in
    if uu____9373
    then
      let uu____9376 =
        let uu____9379 = range_of_bv bv  in
        FStar_Pervasives_Native.Some uu____9379  in
      new_bv uu____9376 bv.sort
    else
      (let uu___607_9382 = bv  in
       let uu____9383 = FStar_Ident.next_id ()  in
       {
         ppname = (uu___607_9382.ppname);
         index = uu____9383;
         sort = (uu___607_9382.sort)
       })
...
let (freshen_binder : binder -> binder) =
  fun b  ->
    ...
    | (bv,aq) -> let uu____9398 = freshen_bv bv  in (uu____9398, aq)
...
let (new_univ_name :
  ...
  fun ropt  ->
    ...
    let uu____9413 =
      let uu____9419 =
        let uu____9421 = FStar_Util.string_of_int id1  in
        Prims.op_Hat FStar_Ident.reserved_prefix uu____9421  in
      (uu____9419, (range_of_ropt ropt))  in
    FStar_Ident.mk_ident uu____9413
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv  ->
    fun r  ->
      let uu___637_9552 = bv  in
      let uu____9553 =
        FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____9553;
        index = (uu___637_9552.index);
        sort = (uu___637_9552.sort)
      }
...
let (lid_as_fv :
  ...
  fun l  ->
    fun dd  ->
      fun dq  ->
        let uu____9575 =
          let uu____9576 = FStar_Ident.range_of_lid l  in
          withinfo l uu____9576  in
        { fv_name = uu____9575; fv_delta = dd; fv_qual = dq }
  
let (fv_to_tm : fv -> term) =
  fun fv  ->
    let uu____9583 = FStar_Ident.range_of_lid (fv.fv_name).v  in
    mk (Tm_fvar fv) FStar_Pervasives_Native.None uu____9583
...
let (fvar :
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____9604 = lid_as_fv l dd dq  in fv_to_tm uu____9604
  
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv  -> (fv.fv_name).v 
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv  ->
    let uu____9617 = lid_of_fv fv  in FStar_Ident.range_of_lid uu____9617
  
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv  ->
    fun r  ->
      let uu___650_9629 = fv  in
      let uu____9630 =
        let uu___652_9631 = fv.fv_name  in
        let uu____9632 =
          let uu____9633 = lid_of_fv fv  in
          FStar_Ident.set_lid_range uu____9633 r  in
        { v = uu____9632; p = (uu___652_9631.p) }  in
      {
        fv_name = uu____9630;
        fv_delta = (uu___650_9629.fv_delta);
        fv_qual = (uu___650_9629.fv_qual)
      }
...
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___6_9659  ->
           match uu___6_9659 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____9664));
               pos = uu____9665; vars = uu____9666;_} when data = s -> true
           | uu____9673 -> false) l
  ...
  fun p1  ->
    fun p2  ->
      ...
      | (Pat_cons (fv1,as1),Pat_cons (fv2,as2)) ->
          let uu____9732 = fv_eq fv1 fv2  in
          if uu____9732
          then
            let uu____9737 = FStar_List.zip as1 as2  in
      ...
      | (Pat_var uu____9842,Pat_var uu____9843) -> true
      | (Pat_wild uu____9845,Pat_wild uu____9846) -> true
      | (Pat_dot_term (bv1,t1),Pat_dot_term (bv2,t2)) -> true
      | (uu____9861,uu____9862) -> false
...
let (tconst : FStar_Ident.lident -> term) =
  fun l  ->
    let uu____9880 =
      let uu____9887 = let uu____9888 = fvconst l  in Tm_fvar uu____9888  in
      mk uu____9887  in
    uu____9880 FStar_Pervasives_Native.None FStar_Range.dummyRange
      ...
      let uu____9902 =
        let uu____9903 =
          lid_as_fv l (Delta_constant_at_level (Prims.parse_int "1"))
           ...
           in
        Tm_fvar uu____9903  in
      mk uu____9902  in
    uu____9895 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tactic_unit : term) =
  let uu____9930 =
    let uu____9935 =
      let uu____9936 = tabbrev FStar_Parser_Const.tactic_lid  in
      mk_Tm_uinst uu____9936 [U_zero]  in
    let uu____9937 = let uu____9938 = as_arg t_unit  in [uu____9938]  in
    mk_Tm_app uu____9935 uu____9937  in
  uu____9930 FStar_Pervasives_Native.None FStar_Range.dummyRange 
let (t_list_of : term -> term) =
  fun t  ->
    let uu____9969 =
      let uu____9974 =
        let uu____9975 = tabbrev FStar_Parser_Const.list_lid  in
        mk_Tm_uinst uu____9975 [U_zero]  in
      let uu____9976 = let uu____9977 = as_arg t  in [uu____9977]  in
...
let (t_option_of : term -> term) =
  fun t  ->
    let uu____10008 =
      let uu____10013 =
        let uu____10014 = tabbrev FStar_Parser_Const.option_lid  in
        mk_Tm_uinst uu____10014 [U_zero]  in
      let uu____10015 = let uu____10016 = as_arg t  in [uu____10016]  in
      mk_Tm_app uu____10013 uu____10015  in
    uu____10008 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tuple2_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10052 =
        let uu____10057 =
          let uu____10058 = tabbrev FStar_Parser_Const.lid_tuple2  in
          mk_Tm_uinst uu____10058 [U_zero; U_zero]  in
        let uu____10059 =
          let uu____10060 = as_arg t1  in
          let uu____10069 = let uu____10080 = as_arg t2  in [uu____10080]  in
          uu____10060 :: uu____10069  in
        mk_Tm_app uu____10057 uu____10059  in
...
let (t_either_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10124 =
        let uu____10129 =
          let uu____10130 = tabbrev FStar_Parser_Const.either_lid  in
          mk_Tm_uinst uu____10130 [U_zero; U_zero]  in
        let uu____10131 =
          let uu____10132 = as_arg t1  in
          let uu____10141 = let uu____10152 = as_arg t2  in [uu____10152]  in
